...
struct RustGlobalsStruct rust_init(uint8_t core_id, int cores_total, char* tcp_db_source_name, size_t gre_offset);
...
uint8_t rust_print_avg_stats(void* rust_global, long current, long total, bool debug);
